...
export const metadata: Metadata = {
  title: "Roasted - Crafted Coffee & Perfect Moments",
  description: "Experience expertly roasted coffee beans and artisan brewing techniques. From rich espressos to smooth cold brews, discover your perfect cup at Roasted.",
  keywords: "coffee shop, roasted coffee, espresso, latte, cold brew, artisan coffee, specialty coffee",
  openGraph: {
    title: "Roasted - Crafted Coffee & Perfect Moments",
    description: "Experience expertly roasted coffee beans and artisan brewing techniques. From rich espressos to smooth cold brews, discover your perfect cup.",
    siteName: "Roasted",
    images: [
      {
        url: "https://images.pexels.com/photos/23384632/pexels-photo-23384632.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Modern coffee shop interior with warm lighting"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Roasted - Crafted Coffee & Perfect Moments",
    description: "Experience expertly roasted coffee beans and artisan brewing techniques.",
